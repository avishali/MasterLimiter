...
| 15 | **NEXT — Meter ballistics** | — | GR + Clip + loudness meter ballistics | Beta-prep batch. Tune attack, release-decay, and peak-hold behavior so meters read musically and consistently before beta. |
| 16 | **Beta prep — UI/UX interaction** | — | UI interaction polish | Type-in parameter values / double-click edit, tooltips, label clarity, final layout + resize polish, and Color knob placement lock. |
...
Note: Slice 14 (2-band multiband limiting + Color, ADR-0009)
closed 2026-05-30. The next batch prepares a beta build for
avishali's beta tester: Slice 15 meter ballistics, Slice 16 UI/UX
